...
this.element.stopChange().appendChild(g);"function"===typeof a&&a(g)}}function D(){this.maps[this.key].splice(this.id,1);return this}function E(){for(var a=0,n=this.bindNames.length;a<n;a++)this._data.removeDataUpdateListener&&(this._data.removeDataUpdateListener(this.bindNames[a],this.updateDom),this._value.removeDataUpdateListener("*",this.updateLoop).removeDataCreateListener(this.updateLoop).removeDataDeleteListener(this.updateLoop));this.element.removeAttrUpdateListener("text"===this.type?"html":
this.bindListener,this.updateData);this.bindMaps=this.maps=this.bindNames=this.filters=this._data=null;this.__proto__._data=null;this.__proto__.element=null;this.__proto__.filters=null;this.__proto__.bindTarget=null;this.__proto__.bindText=null;this.__proto__.bindNames=null;this.__proto__.element=null;this.__proto__.maps=null;this.__proto__.bindMaps=null;return!1}function L(a){return a.split(new RegExp("("+u.split("").join("\\")+")(.*?)("+r.split("").join("\\")+")","g")).map(function(a,f,b){return b[f-
1]===u?u+a+r:a}).filter(function(a,f,b){return 0!==a.length&&a!==u&&a!==r&&0!==a.length})}function Q(a){return a.filter(function(a){return-1!==a.indexOf(u)&&-1!==a.indexOf(r)}).map(function(a){return K(a)})}function K(a){return a.replace(new RegExp("["+u+r+"]","g"),"").replace(new RegExp("\\"+y.split("").join("\\")+"(.*)"),"").replace(/\s/g,"")}function M(a){return-1!==a.indexOf(y)?a.replace(new RegExp("["+r+"]","g"),"").replace(new RegExp("(.*?)(\\"+y.split("").join("\\")+")"),"").replace(/\s/g,
"").split(","):[]}function J(a){return-1!==a.indexOf("for")?a.replace(new RegExp("["+u+r+"]","g"),"").replace(/\|(.*)/,"").replace(/\s/g,"").split(/for(.*?)loop/).filter(function(a){return 0!==a.length}):[]}function k(a,f,k){return{value:a,writable:!!f,enumerable:!1,configurable:!!k}}function f(a,f){for(var k=x[a],b=0,g=k.length;b<g&&(k[b](f),f._stopPropogation);b++);return f._preventDefault}function A(a){var n=a.match(C).map(function(a){return a.replace(/[<\/>]/g,"")});n.filter(function(a,b){return document.createElement(a)instanceof
HTMLUnknownElement&&-1===n.indexOf(a,b+1)&&void 0===z[a]});0!==n.length&&f("unknown",new Event("unknown",n));return n}var z={},C=/(<\/.*?>)/g;S().call();var B=Object.keys(HTMLElement.prototype).filter(function(a){return 0===a.indexOf("on")}),u="{{",r="}}",y="|",x={unknown:[]};m.prototype.map=function(a){function f(b){for(var g=0,c=b.length;g<c;g++)if(void 0===b[g].kb_maps&&8!==b[g].nodeType){b[g].kb_mapper=a;if(3===b[g].nodeType){var d=b[g],l=k,e=d.textContent,h=d.parentElement instanceof HTMLUnknownElement;
if(e.match(new RegExp("(\\"+u.split("").join("\\")+")(.*?)(\\"+r.split("").join("\\")+")","g")))for(var v=h?"component":-1!==e.indexOf("for")&&void 0!==e.indexOf("loop")?"for":"text",d=w(l,v,e,L(e),h?"":"textContent","textContent",d,d.parentElement),e=0,h=d.prototype.bindText.length;e<h;e++){var v=e,p=d.prototype.bindText[e];0===p.indexOf(u)&&(p=new d(p),d.prototype.bindText[v]=p,void 0===l[p.key]&&(l[p.key]=[]),p.id=l[p.key].length,l[p.key].push(p))}}else for(l=b[g],d=k,e=l.attributes,h=l instanceof
HTMLUnknownElement,v=0,p=e.length;v<p;v++){var q=e[v];if(q.value.match(new RegExp("(\\"+u.split("").join("\\")+")(.*?)(\\"+r.split("").join("\\")+")","g")))for(var q=w(d,h?"component":"attribute",q.value,L(q.value),h?"":q.name,"value",q,l),t=0,U=q.prototype.bindText.length;t<U;t++){var m=t,F=q.prototype.bindText[t];0===F.indexOf(u)&&(F=new q(F),q.prototype.bindText[m]=F,void 0===d[F.key]&&(d[F.key]=[]),d[F.key].push(F))}}b[g].childNodes&&0!==b[g].childNodes.length&&f(b[g].childNodes)}}var k={};f(a.childNodes);
return k};m.prototype.addFilter=function(a,f){void 0!==this.maps[a]&&this.maps[a].forEach(function(a){a.filters.push(f);a.refresh()});return this};m.prototype.removeFilter=function(a,f){void 0!==this.maps[a]&&this.maps[a].forEach(function(k){k.filters.splice(this.maps[a].filters.indexOf(f),1);k.refresh()});return this};m.prototype.swapFilter=function(a,f,k){void 0!==this.maps[a]&&this.maps[a].forEach(function(b){b.filters.splice(this.maps[a].filters.indexOf(f),1,k);b.refresh()});return this};Object.defineProperties(m,
{startChars:k(function(a){if(void 0===a)return u;u="string"===typeof a?a:u;return this}),endChars:k(function(a){if(void 0===a)return r;r="string"===typeof a?a:r;return this}),pipeChars:k(function(a){if(void 0===a)return y;y="string"===typeof a?a:y;return this}),getUnknown:k(A),isRegistered:k(function(a){return void 0!==z[a]}),register:k(function(a,f){void 0===z[a]?(z[a]=f,A(f)):console.error("Class: KonnektMP Method: 'register', A template by the name %o already exists",a);return this}),addEventListener:k(function(a,
f){void 0!==x[a]?x[a].push(f):console.error("Class: KonnektMP Method: 'addEventListener', No event exists with the name %o",a);return this}),removeEventListener:k(function(a,f){if(void 0!==x[a])for(var k=0,b=x[a].length;k<b;k++)x[a][k].toString()===f.toString()&&x[a].splice(k,1);else console.error("Class: KonnektMP Method: 'removeEventListener', No event exists with the name %o",a);return this})});return m}}(function(){function G(){function m(b,g){var c=b.length,d;for(d=0;d<c&&(b[d](g),void 0===g._stopPropogation);d++);
...
p.slice(t,1)}}else e?e=a?"_styleUpdateListeners":"_styleListeners":("*"===b&&(e=a?"_styleUpdateListeners":"_styleListeners",l(b,this.attrListeners()[e])),e=a?"_attrUpdateListeners":"_attrListeners"),l(b,this.attrListeners()[e]);else e?e=a?B:C:("*"===b&&(e=a?B:C,l(b,e)),e=a?z:A),l(b,e)}function L(b,g){f.addAttrListener.call(this,b,g,!0);return this}function Q(b,g){f.addAttrUpdateListener.call(this,b,g,!0);return this}function K(b,g){f.removeAttrListener.call(this,b,g,!0);return this}function M(b,g){f.removeAttrUpdateListener.call(this,
b,g,!0);return this}function J(b,g,c){var a=this.attrListeners();"html"===g&&(g="innerHTML");"events"===g&&(g="onclick");switch(b){case "attr":if(H(a._attrListeners[g],c))return!0;break;case "attrupdate":if(H(a._attrUpdateListeners[g],c))return!0}return!1}function k(){this._stopChange=!0;return this}function f(){function b(b,g){var a,c=g.length;for(a=0;a<c;a++)-1===b.indexOf(g[a])&&b.push(g[a]);return b}function g(b,g){for(var a=Object.keys(b),c,e,d=0,f=a.length;d<f;d++)if(c=a[d],void 0===g[c])g[c]=
b[c].slice();else for(var h=0,l=b[c].length;h<l;h++)e=b[c][h],g[c].push(e)}function c(a){if(3!==a.target.nodeType&&8!==a.target.nodeType){var c=a.target.attrListeners(),e,d=["value","checked"],h=c._attrListeners,l=c._attrUpdateListeners,k=c._parentAttrListeners;e=c._parentAttrUpdateListeners;var n=!1;if(void 0!==A["*"]||void 0!==z["*"])n=!0;if(!0!==n&&void 0!==h["*"]||void 0!==l["*"]||void 0!==k["*"]||void 0!==e["*"])n=!0;if(!0!==n)for(var m=0;m<d.length;m++)if(void 0!==A[d[m]]||void 0!==z[d[m]]||
void 0!==h[d[m]]||void 0!==l[d[m]]||void 0!==k[d[m]]||void 0!==e[d[m]]){n=!0;break}e=n;d=Object.keys(C);h=Object.keys(B);Object.keys(c._styleListeners);Object.keys(c._styleUpdateListeners);l=Object.keys(c._parentStyleListeners);c=Object.keys(c._parentStyleUpdateListeners);k=[];if(0!==d.length||0!==h.length)k=b(k,d),k=b(k,h);if(0!==k.length&&0!==l.length||0!==c.length)k=b(k,l),k=b(k,c);-1!==k.indexOf("*")&&(k=y);var c=k,d=c.length,u,r,h=[],x,l="outerHTML"===a.attr||"outerText"===a.attr?a.attr:void 0,
k=a.target;void 0!==l&&(a.attr="appendChild",a.arguments=[a.target],a.target=a.target.parentElement);if(e){"appendChild"===a.attr&&3!==a.arguments[0].nodeType&&8!==a.arguments[0].nodeType?(h=Array.prototype.slice.call(a.arguments[0].querySelectorAll("input,textarea")),"INPUT"!==a.arguments[0].tagName&&"TEXTAREA"!==a.arguments[0].tagName||h.unshift(a.arguments[0])):h=Array.prototype.slice.call(a.target.querySelectorAll("input,textarea"));x=h.length;for(var w=0;w<x;w++)void 0!==h[w].addInputBinding&&
h[w].addInputBinding(),void 0!==h[w].addInputBoxBinding&&h[w].addInputBoxBinding()}"appendChild"===a.attr&&"#text"!==a.arguments[0].nodeName&&"#comment"!==a.arguments[0].nodeName?(h=Array.prototype.slice.call(a.arguments[0].querySelectorAll("*")),h.unshift(a.arguments[0])):h=Array.prototype.slice.call(a.target.querySelectorAll("*"));e=a.target.__kb._parentAttrListeners;n=a.target.__kb._parentAttrUpdateListeners;m=a.target.__kb._parentStyleListeners;u=a.target.__kb._parentStyleUpdateListeners;x=h.length;
for(w=0;w<x;w++){if(0!==d)for(r=0;r<d;r++)f.injectStyleProperty(h[w],c[r]);r=h[w].attrListeners();g(e,r._parentAttrListeners);g(n,r._parentAttrUpdateListeners);g(m,r._parentStyleListeners);g(u,r._parentStyleUpdateListeners)}void 0!==l&&(a.attr=l,a.target=k,a.arguments=[])}}function a(b){var c=b.target.attributes[b.arguments[0]],g="setAttribute"===b.attr?b.arguments[1]:"";e(b.target,b.arguments[0],g,void 0!==c?c.value:"",[g])||b.preventDefault()}function l(b){var a=b.target.attributes[b.arguments[0]],
c="setAttribute"===b.attr?b.arguments[1]:"";h(b.target,b.arguments[0],c,void 0!==a?a.value:"",[c])}f.injectPrototypes(Node,"Node");f.injectPrototypes(Element,"Element");f.injectPrototypes(HTMLElement,"HTMLElement");f.injectPrototypes(HTMLInputElement,"HTMLInputElement");f.injectPrototypes(HTMLTextAreaElement,"HTMLTextAreaElement");f.injectPrototypes(Document,"Document");var e=n,h=I;f.addAttrUpdateListener("appendChild",c);f.addAttrUpdateListener("removeChild",c);f.addAttrUpdateListener("innerHTML",
c);f.addAttrUpdateListener("outerHTML",c);f.addAttrUpdateListener("innerText",c);f.addAttrUpdateListener("outerText",c);f.addAttrUpdateListener("textContent",c);f.addAttrListener("setAttribute",a);f.addAttrListener("removeAttribute",a);f.addAttrUpdateListener("setAttribute",l);f.addAttrUpdateListener("removeAttribute",l);return f}var A={},z={},C={},B={},u={},r="textContent innerHTML innerText outerHTML outerText appendChild removeChild replaceChild insertAdjacentHTML insertBefore".split(" "),y=Object.getOwnPropertyNames(document.body.style),
...
void 0===c._stopPropogation&&void 0!==e[a]&&w(e[a],c),void 0===c._stopPropogation&&void 0!==b[a]&&w(b[a],c),void 0===c._stopPropogation&&void 0!==e["*"]&&(w(e["*"],c),void 0===c._stopPropogation&&w(b["*"],c)));void 0===c._stopPropogation&&void 0!==A[a]&&m(A[a],c);void 0===c._stopPropogation&&void 0!==C[a]&&m(C[a],c);void 0===c._stopPropogation&&void 0!==A["*"]&&(m(A["*"],c),void 0===c._stopPropogation&&m(C["*"],c));return void 0!==c._preventDefault?!1:!0},I=function(b,a,c,d,f,e){c=new N(b,a,c,d,f,
...
c),void 0===c._stopPropogation&&w(b["*"],c)));void 0===c._stopPropogation&&void 0!==z[a]&&m(z[a],c);void 0===c._stopPropogation&&void 0!==B[a]&&m(B[a],c);void 0===c._stopPropogation&&void 0!==z["*"]&&(m(z["*"],c),void 0===c._stopPropogation&&m(B["*"],c));return void 0!==c._preventDefault?!1:!0};f.injectPrototypeProperty=function(b,a,c,d,l){var e=b.prototype,h=Object.getOwnPropertyDescriptor(e,a);c=c||b.toString().split(/\s+/)[1].split("{")[0].replace("()","");var m=u[c];d=d||n;l=l||I;void 0===e.attrListeners&&
(e={},e.attrListeners=function(){void 0===this.__kb&&(this.__kb=new P);return this.__kb}.bind(e),e.addAttrListener=f.addAttrListener,e.addAttrUpdateListener=f.addAttrUpdateListener,e.addChildAttrListener=L,e.addChildAttrUpdateListener=Q,e.hasListener=J,e.removeAttrListener=f.removeAttrListener,e.removeAttrUpdateListener=f.removeAttrUpdateListener,e.removeChildAttrListener=K,e.removeChildAttrUpdateListener=M,e.stopChange=k);void 0===m&&(u[c]={obj:b,proto:e,descriptors:{},set:void 0,update:void 0},
m=u[c],m.set=d,m.update=l);void 0===m.descriptors[a]&&(m.descriptors[a]=h);h.configurable&&(void 0!==h.set?Object.defineProperty(e,a,{get:h.get,set:R(h,a,d,l),enumerable:!0,configurable:!0}):"function"===typeof h.value?Object.defineProperty(e,a,{value:T(h,a,d,l),writable:!0,enumerable:!0,configurable:!0}):void 0!==h.value&&Object.defineProperty(e,a,{get:function(){return h.value},set:S(h,a,d,l),enumerable:!0,configurable:!0}));return f};f.injectStyleProperty=function(b,a,c,d){var k=b.style,e=Object.getOwnPropertyDescriptor(k,
a),h=b.attrListeners().injectedStyle;c=c||n;d=d||I;void 0===h&&(b.attrListeners().injectedStyle={obj:b,proto:k,descriptors:{},set:void 0,update:void 0},b.attrListeners().injectedStyle.set=c,b.attrListeners().injectedStyle.update=d,h=b.attrListeners().injectedStyle);void 0===h.descriptors[a]&&(h.descriptors[a]=e);e.configurable&&Object.defineProperty(k,a,O(e,a,c,d,b));return f};f.injectPrototypes=function(b,a,c,d){var l=b.prototype;a=a||b.toString().split(/\s+/)[1].split("{")[0].replace("()","");var e=
u[a],h=Object.getOwnPropertyNames(l);c=c||n;d=d||I;var m;void 0===l.attrListeners&&(l.attrListeners=function(){void 0===this.__kb&&(this.__kb=new P);return this.__kb},l.addAttrListener=f.addAttrListener,l.addAttrUpdateListener=f.addAttrUpdateListener,l.addChildAttrListener=L,l.addChildAttrUpdateListener=Q,l.removeAttrListener=f.removeAttrListener,l.removeAttrUpdateListener=f.removeAttrUpdateListener,l.removeChildAttrListener=K,l.removeChildAttrUpdateListener=M,l.hasListener=J,l.stopChange=k);void 0===
e&&(u[a]={obj:b,proto:l,descriptors:{},set:void 0,update:void 0},e=u[a],e.set=c,e.update=d);m=u[a].descriptors;for(d=0;d<h.length;d+=1)void 0===m[h[d]]&&f.injectPrototypeProperty(b,h[d],a,c,I);if(-1!==h.indexOf("value")){var p=function(b){var a,c,d;if("checkbox"===this.type||"radio"===this.type)a=!0;c=a?"string"===typeof this.checked?this.checked:this.checked?"true":"false":this.value;setTimeout(function(){d=a?"string"===typeof this.checked?this.checked:this.checked?"true":"false":this.value;a&&(e.set(this,
"checked",this.checked,c)?e.update(this,"checked",this.checked,c):m.checked.set.call(this,c));this.value=d;e.set(this,"value",this.value,c)?e.update(this,"value",this.value,c):m.value.set.call(this,c)}.bind(this),0)};l.removeInputBinding=function(){this.attrListeners()._onkeydown=void 0;this.removeEventListener("keydown",p)};l.addInputBinding=function(){this.attrListeners()._onkeydown=!0;this.addEventListener("keydown",p)};l.removeInputBoxBinding=function(){this.attrListeners()._onmousedown=void 0;
this.removeEventListener("mouseup",p)};l.addInputBoxBinding=function(){this.attrListeners()._onmousedown=!0;this.addEventListener("mouseup",p)}}return f};f.addAttrListener=function(b,a,c){if("html"===b){b=0;for(var d=r.length;b<d;b++)D.call(this,r[b],a,c,!1)}else if("events"===b)for(b=0,d=x.length;b<d;b++)D.call(this,x[b],a,c,!1);else D.call(this,b,a,c,!1);return this};f.addAttrUpdateListener=function(b,a,c){if("html"===b){b=0;for(var d=r.length;b<d;b++)D.call(this,r[b],a,c,!0)}else if("events"===
b)for(b=0,d=x.length;b<d;b++)D.call(this,x[b],a,c,!0);else D.call(this,b,a,c,!0);return this};f.removeAttrListener=function(b,a,c){if("html"===b){b=0;for(var d=r.length;b<d;b++)E.call(this,r[b],a,c,!1)}else if("events"===b)for(b=0,d=x.length;b<d;b++)E.call(this,x[b],a,c,!1);else E.call(this,b,a,c,!1);return this};f.removeAttrUpdateListener=function(b,a,c){if("html"===b){b=0;for(var d=r.length;b<d;b++)E.call(this,r[b],a,c,!0)}else if("events"===b)for(b=0,d=x.length;b<d;b++)E.call(this,x[b],a,c,!0);
else E.call(this,b,a,c,!0);return this};f.hasListener=function(b,a,c){"html"===a&&(a="innerHTML");"events"===a&&(a="onclick");switch(b){case "attr":if(H(A[a],c))return!0;break;case "attrupdate":if(H(z[a],c))return!0}return!1};f.injectedPrototypes=function(){return u};return f}"function"===typeof define&&define.amd&&define("KB",G);return G}());"undefined"!==typeof window&&"undefined"!==typeof window.define&&"undefined"!==typeof window.require?define([],function(){return G}):"undefined"!==typeof module&&
