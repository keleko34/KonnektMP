...
l.length?"string"===typeof l[0]._value?f(b,l):l[0]._value:f(b,l)}function H(){"for"!==this.type&&(this.isEvent?this.element[this.bindProperty]=this.bindText[0]._value:"component"===this.type?(this.element.k_post||(this.element.k_post={}),this.element.k_post["textContent"===this.bindProperty?"innerHTML":this.bindTarget.name]=S(this,this.bindText)):this.bindTarget[this.bindProperty]=S(this,this.bindText));return this}function U(b){this._data=b;this.filters=void 0!==b.filters?b.filters:this.filters;
...
B:E;void 0===h[a]&&(h[a]=[]);h[a].push(g)}h=b?z:A}void 0===h[a]&&(h[a]=[]);h[a].push(g)}}function G(a,g,c,b){function k(a,b){var c=b[a],d=c.length;for(h=0;h<d;h++)c[h].toString()===g.toString()&&c.splice(h,1)}if("function"!==typeof g)return f;["value","checked"].indexOf(a);var d=-1!==y.indexOf(a),h;if(this.toString()!==f.toString())if(c){c=this.querySelectorAll("*");var n=c.length;d?(d=b?"_childStyleUpdateListeners":"_childStyleListeners",k(a,this.attrListeners()[d]),d=b?"_parentStyleUpdateListeners":
"_parentStyleListeners"):("*"===a&&(d=b?"_childStyleUpdateListeners":"_childStyleListeners",k(a,this.attrListeners()[d])),d=b?"_childAttrUpdateListeners":"_childAttrListeners",k(a,this.attrListeners()[d]),d=b?"_parentAttrUpdateListeners":"_parentAttrListeners");for(h=0;h<n;h++){for(var r=c[h].attrListeners()[d][a],p=r.length,u=0;u<p;u++)r[u].isEqualNode(this)&&r.slice(u,1);if("*"===a)for(listenersStyle=b?"_parentStyleUpdateListeners":"_parentStyleListeners",r=c[h].attrListeners()[d][a],p=r.length,
u=0;u<p;u++)r[u].isEqualNode(this)&&r.slice(u,1)}}else d?d=b?"_styleUpdateListeners":"_styleListeners":("*"===a&&(d=b?"_styleUpdateListeners":"_styleListeners",k(a,this.attrListeners()[d])),d=b?"_attrUpdateListeners":"_attrListeners"),k(a,this.attrListeners()[d]);else d?d=b?B:E:("*"===a&&(d=b?B:E,k(a,d)),d=b?z:A),k(a,d)}function L(a,g){f.addAttrListener.call(this,a,g,!0);return this}function R(a,g){f.addAttrUpdateListener.call(this,a,g,!0);return this}function K(a,g){f.removeAttrListener.call(this,
a,g,!0);return this}function N(a,g){f.removeAttrUpdateListener.call(this,a,g,!0);return this}function J(a,g,c){var b=this.attrListeners();"html"===g&&(g="innerHTML");"events"===g&&(g="onclick");switch(a){case "attr":if(I(b._attrListeners[g],c))return!0;break;case "attrupdate":if(I(b._attrUpdateListeners[g],c))return!0}return!1}function m(){this._stopChange=!0;return this}function f(){function a(a,b){var g,c=b.length;for(g=0;g<c;g++)-1===a.indexOf(b[g])&&a.push(b[g]);return a}function g(a,b){for(var g=
Object.keys(a),c,d,e=0,f=g.length;e<f;e++)if(c=g[e],void 0===b[c])b[c]=a[c].slice();else for(var h=0,k=a[c].length;h<k;h++)d=a[c][h],b[c].push(d)}function b(c){if(3!==c.target.nodeType&&8!==c.target.nodeType){var d=c.target.attrListeners(),e,h=["value","checked"],k=d._attrListeners,m=d._attrUpdateListeners,l=d._parentAttrListeners;e=d._parentAttrUpdateListeners;var t=!1;if(void 0!==A["*"]||void 0!==z["*"])t=!0;if(!0!==t&&void 0!==k["*"]||void 0!==m["*"]||void 0!==l["*"]||void 0!==e["*"])t=!0;if(!0!==
t)for(var q=0;q<h.length;q++)if(void 0!==A[h[q]]||void 0!==z[h[q]]||void 0!==k[h[q]]||void 0!==m[h[q]]||void 0!==l[h[q]]||void 0!==e[h[q]]){t=!0;break}e=t;h=Object.keys(E);k=Object.keys(B);Object.keys(d._styleListeners);Object.keys(d._styleUpdateListeners);m=Object.keys(d._parentStyleListeners);d=Object.keys(d._parentStyleUpdateListeners);l=[];if(0!==h.length||0!==k.length)l=a(l,h),l=a(l,k);if(0!==l.length&&0!==m.length||0!==d.length)l=a(l,m),l=a(l,d);-1!==l.indexOf("*")&&(l=y);var d=l,h=d.length,
w,v,k=[],x,m="outerHTML"===c.attr||"outerText"===c.attr?c.attr:void 0,l=c.target;void 0!==m&&(c.attr="appendChild",c.arguments=[c.target],c.target=c.target.parentElement);if(e){"appendChild"===c.attr&&3!==c.arguments[0].nodeType&&8!==c.arguments[0].nodeType?(k=Array.prototype.slice.call(c.arguments[0].querySelectorAll("input,textarea")),"INPUT"!==c.arguments[0].tagName&&"TEXTAREA"!==c.arguments[0].tagName||k.unshift(c.arguments[0])):k=Array.prototype.slice.call(c.target.querySelectorAll("input,textarea"));
x=k.length;for(var C=0;C<x;C++)void 0!==k[C].addInputBinding&&k[C].addInputBinding(),void 0!==k[C].addInputBoxBinding&&k[C].addInputBoxBinding()}"appendChild"===c.attr&&"#text"!==c.arguments[0].nodeName&&"#comment"!==c.arguments[0].nodeName?(k=Array.prototype.slice.call(c.arguments[0].querySelectorAll("*")),k.unshift(c.arguments[0])):k=Array.prototype.slice.call(c.target.querySelectorAll("*"));e=c.target.__kb._parentAttrListeners;t=c.target.__kb._parentAttrUpdateListeners;q=c.target.__kb._parentStyleListeners;
w=c.target.__kb._parentStyleUpdateListeners;x=k.length;for(C=0;C<x;C++){if(0!==h)for(v=0;v<h;v++)f.injectStyleProperty(k[C],d[v]);v=k[C].attrListeners();g(e,v._parentAttrListeners);g(t,v._parentAttrUpdateListeners);g(q,v._parentStyleListeners);g(w,v._parentStyleUpdateListeners)}void 0!==m&&(c.attr=m,c.target=l,c.arguments=[])}}function e(a){var c=a.target.attributes[a.arguments[0]],b="setAttribute"===a.attr?a.arguments[1]:"";d(a.target,a.arguments[0],b,void 0!==c?c.value:"",[b])||a.preventDefault()}
function k(a){var c=a.target.attributes[a.arguments[0]],b="setAttribute"===a.attr?a.arguments[1]:"";h(a.target,a.arguments[0],b,void 0!==c?c.value:"",[b])}f.injectPrototypes(Node,"Node");f.injectPrototypes(Element,"Element");f.injectPrototypes(HTMLElement,"HTMLElement");f.injectPrototypes(HTMLInputElement,"HTMLInputElement");f.injectPrototypes(HTMLTextAreaElement,"HTMLTextAreaElement");f.injectPrototypes(Document,"Document");var d=l,h=D;f.addAttrUpdateListener("appendChild",b);f.addAttrUpdateListener("removeChild",
b);f.addAttrUpdateListener("innerHTML",b);f.addAttrUpdateListener("outerHTML",b);f.addAttrUpdateListener("innerText",b);f.addAttrUpdateListener("outerText",b);f.addAttrUpdateListener("textContent",b);f.addAttrListener("setAttribute",e);f.addAttrListener("removeAttribute",e);f.addAttrUpdateListener("setAttribute",k);f.addAttrUpdateListener("removeAttribute",k);return f}var A={},z={},E={},B={},q={},w="textContent innerHTML innerText outerHTML outerText appendChild removeChild replaceChild insertAdjacentHTML insertBefore".split(" "),
...
function(a,b,c,e){var k=a.style,d=Object.getOwnPropertyDescriptor(k,b),h=a.attrListeners().injectedStyle;c=c||l;e=e||D;void 0===h&&(a.attrListeners().injectedStyle={obj:a,proto:k,descriptors:{},set:void 0,update:void 0},a.attrListeners().injectedStyle.set=c,a.attrListeners().injectedStyle.update=e,h=a.attrListeners().injectedStyle);void 0===h.descriptors[b]&&(h.descriptors[b]=d);d.configurable&&Object.defineProperty(k,b,P(d,b,c,e,a));return f};f.injectPrototypes=function(a,b,c,e){var k=a.prototype;
b=b||a.toString().split(/\s+/)[1].split("{")[0].replace("()","");var d=q[b],h=Object.getOwnPropertyNames(k);c=c||l;e=e||D;var n;void 0===k.attrListeners&&(k.attrListeners=function(){void 0===this.__kb&&(this.__kb=new Q);return this.__kb},k.addAttrListener=f.addAttrListener,k.addAttrUpdateListener=f.addAttrUpdateListener,k.addChildAttrListener=L,k.addChildAttrUpdateListener=R,k.removeAttrListener=f.removeAttrListener,k.removeAttrUpdateListener=f.removeAttrUpdateListener,k.removeChildAttrListener=K,
k.removeChildAttrUpdateListener=N,k.hasListener=J,k.stopChange=m);void 0===d&&(q[b]={obj:a,proto:k,descriptors:{},set:void 0,update:void 0},d=q[b],d.set=c,d.update=e);n=q[b].descriptors;for(e=0;e<h.length;e+=1)void 0===n[h[e]]&&f.injectPrototypeProperty(a,h[e],b,c,D);if(-1!==h.indexOf("value")){var r=function(a){var b,c,g;if("checkbox"===this.type||"radio"===this.type)b=!0;c=b?"string"===typeof this.checked?this.checked:this.checked?"true":"false":this.value;setTimeout(function(){g=b?"string"===typeof this.checked?
