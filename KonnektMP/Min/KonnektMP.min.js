...
HTMLUnknownElement,v=0,p=e.length;v<p;v++){var p=e.length,q=e[v];if(q.value.match(new RegExp("(\\"+u.split("").join("\\")+")(.*?)(\\"+r.split("").join("\\")+")","g")))for(var q=w(d,h?"component":"attribute",q.value,L(q.value),h?"":q.name,"value",q,l),t=0,U=q.prototype.bindText.length;t<U;t++){var m=t,F=q.prototype.bindText[t];0===F.indexOf(u)&&(F=new q(F),q.prototype.bindText[m]=F,void 0===d[F.key]&&(d[F.key]=[]),d[F.key].push(F))}}b[g].childNodes&&0!==b[g].childNodes.length&&f(b[g].childNodes)}}
var k={};f(a.childNodes);return k};m.prototype.addFilter=function(a,f){void 0!==this.maps[a]&&this.maps[a].forEach(function(a){a.filters.push(f);a.refresh()});return this};m.prototype.removeFilter=function(a,f){void 0!==this.maps[a]&&this.maps[a].forEach(function(k){k.filters.splice(this.maps[a].filters.indexOf(f),1);k.refresh()});return this};m.prototype.swapFilter=function(a,f,k){void 0!==this.maps[a]&&this.maps[a].forEach(function(b){b.filters.splice(this.maps[a].filters.indexOf(f),1,k);b.refresh()});
return this};Object.defineProperties(m,{startChars:k(function(a){if(void 0===a)return u;u="string"===typeof a?a:u;return this}),endChars:k(function(a){if(void 0===a)return r;r="string"===typeof a?a:r;return this}),pipeChars:k(function(a){if(void 0===a)return y;y="string"===typeof a?a:y;return this}),getUnknown:k(A),isRegistered:k(function(a){return void 0!==z[a]}),register:k(function(a,f){void 0===z[a]?(z[a]=f,A(f)):console.error("Class: KonnektMP Method: 'register', A template by the name %o already exists",
a);return this}),addEventListener:k(function(a,f){void 0!==x[a]?x[a].push(f):console.error("Class: KonnektMP Method: 'addEventListener', No event exists with the name %o",a);return this}),removeEventListener:k(function(a,f){if(void 0!==x[a])for(var k=0,b=x[a].length;k<b;k++)x[a][k].toString()===f.toString()&&x[a].splice(k,1);else console.error("Class: KonnektMP Method: 'removeEventListener', No event exists with the name %o",a);return this})});return m}}(function(){function G(){function m(b,g){var c=
...
c),void 0===c._stopPropogation&&m(f["*"],c)),void 0===c._stopPropogation&&void 0!==e[a]&&w(e[a],c),void 0===c._stopPropogation&&void 0!==b[a]&&w(b[a],c),void 0===c._stopPropogation&&void 0!==e["*"]&&(w(e["*"],c),void 0===c._stopPropogation&&w(b["*"],c)));void 0===c._stopPropogation&&void 0!==A[a]&&m(A[a],c);void 0===c._stopPropogation&&void 0!==C[a]&&m(C[a],c);void 0===c._stopPropogation&&void 0!==A["*"]&&(m(A["*"],c),void 0===c._stopPropogation&&m(C["*"],c));return void 0!==c._preventDefault?!1:
...
c._stopPropogation&&void 0!==e["*"]&&(w(e["*"],c),void 0===c._stopPropogation&&w(b["*"],c)));void 0===c._stopPropogation&&void 0!==z[a]&&m(z[a],c);void 0===c._stopPropogation&&void 0!==B[a]&&m(B[a],c);void 0===c._stopPropogation&&void 0!==z["*"]&&(m(z["*"],c),void 0===c._stopPropogation&&m(B["*"],c));return void 0!==c._preventDefault?!1:!0};f.injectPrototypeProperty=function(b,a,c,d,l){var e=b.prototype,h=Object.getOwnPropertyDescriptor(e,a);c=c||b.toString().split(/\s+/)[1].split("{")[0].replace("()",
"");var m=u[c];d=d||n;l=l||I;void 0===e.attrListeners&&(e={},e.attrListeners=function(){void 0===this.__kb&&(this.__kb=new P);return this.__kb}.bind(e),e.addAttrListener=f.addAttrListener,e.addAttrUpdateListener=f.addAttrUpdateListener,e.addChildAttrListener=L,e.addChildAttrUpdateListener=Q,e.hasListener=J,e.removeAttrListener=f.removeAttrListener,e.removeAttrUpdateListener=f.removeAttrUpdateListener,e.removeChildAttrListener=K,e.removeChildAttrUpdateListener=M,e.stopChange=k);void 0===m&&(u[c]={obj:b,
proto:e,descriptors:{},set:void 0,update:void 0},m=u[c],m.set=d,m.update=l);void 0===m.descriptors[a]&&(m.descriptors[a]=h);h.configurable&&(void 0!==h.set?Object.defineProperty(e,a,{get:h.get,set:R(h,a,d,l),enumerable:!0,configurable:!0}):"function"===typeof h.value?Object.defineProperty(e,a,{value:T(h,a,d,l),writable:!0,enumerable:!0,configurable:!0}):void 0!==h.value&&Object.defineProperty(e,a,{get:function(){return h.value},set:S(h,a,d,l),enumerable:!0,configurable:!0}));return f};f.injectStyleProperty=
function(b,a,c,d){var k=b.style,e=Object.getOwnPropertyDescriptor(k,a),h=b.attrListeners().injectedStyle;c=c||n;d=d||I;void 0===h&&(b.attrListeners().injectedStyle={obj:b,proto:k,descriptors:{},set:void 0,update:void 0},b.attrListeners().injectedStyle.set=c,b.attrListeners().injectedStyle.update=d,h=b.attrListeners().injectedStyle);void 0===h.descriptors[a]&&(h.descriptors[a]=e);e.configurable&&Object.defineProperty(k,a,O(e,a,c,d,b));return f};f.injectPrototypes=function(b,a,c,d){var l=b.prototype;
a=a||b.toString().split(/\s+/)[1].split("{")[0].replace("()","");var e=u[a],h=Object.getOwnPropertyNames(l);c=c||n;d=d||I;var m;void 0===l.attrListeners&&(l.attrListeners=function(){void 0===this.__kb&&(this.__kb=new P);return this.__kb},l.addAttrListener=f.addAttrListener,l.addAttrUpdateListener=f.addAttrUpdateListener,l.addChildAttrListener=L,l.addChildAttrUpdateListener=Q,l.removeAttrListener=f.removeAttrListener,l.removeAttrUpdateListener=f.removeAttrUpdateListener,l.removeChildAttrListener=K,
l.removeChildAttrUpdateListener=M,l.hasListener=J,l.stopChange=k);void 0===e&&(u[a]={obj:b,proto:l,descriptors:{},set:void 0,update:void 0},e=u[a],e.set=c,e.update=d);m=u[a].descriptors;for(d=0;d<h.length;d+=1)void 0===m[h[d]]&&f.injectPrototypeProperty(b,h[d],a,c,I);if(-1!==h.indexOf("value")){var p=function(b){var a,c,d;if("checkbox"===this.type||"radio"===this.type)a=!0;c=a?"string"===typeof this.checked?this.checked:this.checked?"true":"false":this.value;setTimeout(function(){d=a?"string"===typeof this.checked?
...
d;b++)D.call(this,r[b],a,c,!0)}else if("events"===b)for(b=0,d=x.length;b<d;b++)D.call(this,x[b],a,c,!0);else D.call(this,b,a,c,!0);return this};f.removeAttrListener=function(b,a,c){if("html"===b){b=0;for(var d=r.length;b<d;b++)E.call(this,r[b],a,c,!1)}else if("events"===b)for(b=0,d=x.length;b<d;b++)E.call(this,x[b],a,c,!1);else E.call(this,b,a,c,!1);return this};f.removeAttrUpdateListener=function(b,a,c){if("html"===b){b=0;for(var d=r.length;b<d;b++)E.call(this,r[b],a,c,!0)}else if("events"===b)for(b=
