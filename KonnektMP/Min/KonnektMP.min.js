...
m;b++)this._data.addDataUpdateListener&&(this._data.exists(this.bindNames[b])||(console.warn("No property by the name %o exists on this data set %o",this.bindNames[b],this._data),this._data.add(this.bindNames[b],this._value)),this.value=this._data.get(this.bindNames[b]),"component"!==this.type&&"for"!==this.type?(this.isConnected=!0,this._data.addDataUpdateListener(this.bindNames[b],this.updateDom)):"for"===this.type&&this._value.addDataUpdateListener&&this._value.addDataUpdateListener("*",this.updateLoop).addDataCreateListener(this.updateLoop).addDataDeleteListener(this.updateLoop));
1!==this.bindText.length||"text"!==this.type&&"attribute"!==this.type&&!this.isEvent||this.element.addAttrUpdateListener("text"===this.type?"html":this.bindListener,this.updateData);return this}function P(b){this.kb_loop=b;this.element.stopChange().innerHTML="";for(var m=this._value,f=0,a=this.filterNames.length;f<a;f++)m=this.filters[this.filterNames[f]](m);m=0;for(f=this._value.length;m<f;m++)a=document.createElement(this.component),a.k_post=this._value[m],a.kb_wrapper=this.element.kb_wrapper,this.element.stopChange().appendChild(a),
"function"===typeof b&&b(a)}function F(){this.maps[this.key].splice(this.id,1);return this}function G(){for(var b=0,m=this.bindNames.length;b<m;b++)this._data.removeDataUpdateListener&&(this._data.removeDataUpdateListener(this.bindNames[b],this.updateDom),this._value.removeDataUpdateListener("*",this.updateLoop).removeDataCreateListener(this.updateLoop).removeDataDeleteListener(this.updateLoop));this.element.removeAttrUpdateListener("text"===this.type?"html":this.bindListener,this.updateData);this.maps=
this.bindNames=this.filters=this._data=null;this.__proto__._data=null;this.__proto__.element=null;this.__proto__.filters=null;this.__proto__.bindTarget=null;this.__proto__.bindText=null;this.__proto__.bindNames=null;this.__proto__.element=null;this.__proto__.maps=null;return!1}function L(b){return b.split(new RegExp("("+q.split("").join("\\")+")(.*?)("+w.split("").join("\\")+")","g")).map(function(b,f,a){return a[f-1]===q?q+b+w:b}).filter(function(b,f,a){return 0!==b.length&&b!==q&&b!==w&&0!==b.length})}
function R(b){return b.filter(function(b){return-1!==b.indexOf(q)&&-1!==b.indexOf(w)}).map(function(b){return K(b)})}function K(b){return b.replace(new RegExp("["+q+w+"]","g"),"").replace(new RegExp("\\"+y.split("").join("\\")+"(.*)"),"").replace(/\s/g,"")}function N(b){return-1!==b.indexOf(y)?b.replace(new RegExp("["+w+"]","g"),"").replace(new RegExp("(.*?)(\\"+y.split("").join("\\")+")"),"").replace(/\s/g,"").split(","):[]}function J(b){return-1!==b.indexOf("for")?b.replace(new RegExp("["+q+w+"]",
"g"),"").replace(/\|(.*)/,"").replace(/\s/g,"").split(/for(.*?)loop/).filter(function(b){return 0!==b.length}):[]}function l(b,f,D){return{value:b,writable:!!f,enumerable:!1,configurable:!!D}}function f(b,f){for(var D=v[b],a=0,g=D.length;a<g&&(D[a](f),f._stopPropogation);a++);return f._preventDefault}function A(b){var m=b.match(E).map(function(b){return b.replace(/[<\/>]/g,"")});m.filter(function(b,a){return document.createElement(b)instanceof HTMLUnknownElement&&-1===m.indexOf(b,a+1)&&void 0===z[b]});
0!==m.length&&f("unknown",new Event("unknown",m));return m}var z={},E=/(<\/.*?>)/g;T().call();var B=Object.keys(HTMLElement.prototype).filter(function(b){return 0===b.indexOf("on")}),q="{{",w="}}",y="|",v={unknown:[]};t.prototype.map=function(b){function f(a){for(var g=0,c=a.length;g<c;g++)if(void 0===a[g].kb_maps&&8!==a[g].nodeType){a[g].kb_mapper=b;if(3===a[g].nodeType){var e=a[g],k=l,d=e.textContent,h=e.parentElement instanceof HTMLUnknownElement;if(d.match(new RegExp("(\\"+q.split("").join("\\")+
")(.*?)(\\"+w.split("").join("\\")+")","g")))for(var n=h?"component":-1!==d.indexOf("for")&&void 0!==d.indexOf("loop")?"for":"text",e=x(k,n,d,L(d),h?"":"textContent","textContent",e,e.parentElement),d=0,h=e.prototype.bindText.length;d<h;d++)0===e.prototype.bindText[d].indexOf(q)&&(n=new e(e.prototype.bindText[d]),e.prototype.bindText[d]=n,void 0===k[n.key]&&(k[n.key]=[]),n.id=k[n.key].length,k[n.key].push(n))}else for(var k=a[g],e=l,d=k.attributes,h=k instanceof HTMLUnknownElement,n=0,r=d.length;n<
r;n++)if(d[n].value.match(new RegExp("(\\"+q.split("").join("\\")+")(.*?)(\\"+w.split("").join("\\")+")","g")))for(var p=x(e,h?"component":"attribute",d[n].value,L(d[n].value),h?"":d[n].name,"value",d[n],k),u=0,V=p.prototype.bindText.length;u<V;u++)if(0===p.prototype.bindText[u].indexOf(q)){var M=new p(p.prototype.bindText[u]);p.prototype.bindText[u]=M;void 0===e[M.key]&&(e[M.key]=[]);e[M.key].push(M)}a[g].childNodes&&0!==a[g].childNodes.length&&f(a[g].childNodes)}}var l={};f(b.childNodes);return l};
t.prototype.addFilter=function(b,f){void 0!==this.maps[b]&&this.maps[b].forEach(function(b){b.filters.push(f);b.refresh()});return this};t.prototype.removeFilter=function(b,f){void 0!==this.maps[b]&&this.maps[b].forEach(function(l){l.filters.splice(this.maps[b].filters.indexOf(f),1);l.refresh()});return this};t.prototype.swapFilter=function(b,f,l){void 0!==this.maps[b]&&this.maps[b].forEach(function(a){a.filters.splice(this.maps[b].filters.indexOf(f),1,l);a.refresh()});return this};Object.defineProperties(t,
{startChars:l(function(b){if(void 0===b)return q;q="string"===typeof b?b:q;return this}),endChars:l(function(b){if(void 0===b)return w;w="string"===typeof b?b:w;return this}),pipeChars:l(function(b){if(void 0===b)return y;y="string"===typeof b?b:y;return this}),getUnknown:l(A),isRegistered:l(function(b){return void 0!==z[b]}),register:l(function(b,f){void 0===z[b]?(z[b]=f,A(f)):console.error("Class: KonnektMP Method: 'register', A template by the name %o already exists",b);return this}),addEventListener:l(function(b,
f){void 0!==v[b]?v[b].push(f):console.error("Class: KonnektMP Method: 'addEventListener', No event exists with the name %o",b);return this}),removeEventListener:l(function(b,f){if(void 0!==v[b])for(var l=0,a=v[b].length;l<a;l++)v[b][l].toString()===f.toString()&&v[b].splice(l,1);else console.error("Class: KonnektMP Method: 'removeEventListener', No event exists with the name %o",b);return this})});return t}}(function(){function H(){function t(a,g){var c=a.length,e;for(e=0;e<c&&(a[e](g),void 0===g._stopPropogation);e++);
...
h[a]&&(h[a]=[]);h[a].push(g)}h=b?z:A}void 0===h[a]&&(h[a]=[]);h[a].push(g)}}function G(a,g,c,b){function k(a,b){var c=b[a],d=c.length;for(h=0;h<d;h++)c[h].toString()===g.toString()&&c.splice(h,1)}if("function"!==typeof g)return f;["value","checked"].indexOf(a);var d=-1!==y.indexOf(a),h;if(this.toString()!==f.toString())if(c){c=this.querySelectorAll("*");var n=c.length;d?(d=b?"_childStyleUpdateListeners":"_childStyleListeners",k(a,this.attrListeners()[d]),d=b?"_parentStyleUpdateListeners":"_parentStyleListeners"):
("*"===a&&(d=b?"_childStyleUpdateListeners":"_childStyleListeners",k(a,this.attrListeners()[d])),d=b?"_childAttrUpdateListeners":"_childAttrListeners",k(a,this.attrListeners()[d]),d=b?"_parentAttrUpdateListeners":"_parentAttrListeners");for(h=0;h<n;h++){for(var r=c[h].attrListeners()[d][a],p=r.length,u=0;u<p;u++)r[u].isEqualNode(this)&&r.slice(u,1);if("*"===a)for(listenersStyle=b?"_parentStyleUpdateListeners":"_parentStyleListeners",r=c[h].attrListeners()[d][a],p=r.length,u=0;u<p;u++)r[u].isEqualNode(this)&&
r.slice(u,1)}}else d?d=b?"_styleUpdateListeners":"_styleListeners":("*"===a&&(d=b?"_styleUpdateListeners":"_styleListeners",k(a,this.attrListeners()[d])),d=b?"_attrUpdateListeners":"_attrListeners"),k(a,this.attrListeners()[d]);else d?d=b?B:E:("*"===a&&(d=b?B:E,k(a,d)),d=b?z:A),k(a,d)}function L(a,g){f.addAttrListener.call(this,a,g,!0);return this}function R(a,g){f.addAttrUpdateListener.call(this,a,g,!0);return this}function K(a,g){f.removeAttrListener.call(this,a,g,!0);return this}function N(a,g){f.removeAttrUpdateListener.call(this,
a,g,!0);return this}function J(a,g,c){var b=this.attrListeners();"html"===g&&(g="innerHTML");"events"===g&&(g="onclick");switch(a){case "attr":if(I(b._attrListeners[g],c))return!0;break;case "attrupdate":if(I(b._attrUpdateListeners[g],c))return!0}return!1}function l(){this._stopChange=!0;return this}function f(){function a(a,b){var g,c=b.length;for(g=0;g<c;g++)-1===a.indexOf(b[g])&&a.push(b[g]);return a}function g(a,b){for(var g=Object.keys(a),c,d,e=0,f=g.length;e<f;e++)if(c=g[e],void 0===b[c])b[c]=
a[c].slice();else for(var h=0,k=a[c].length;h<k;h++)d=a[c][h],b[c].push(d)}function b(c){if(3!==c.target.nodeType&&8!==c.target.nodeType){var d=c.target.attrListeners(),e,h=["value","checked"],k=d._attrListeners,l=d._attrUpdateListeners,m=d._parentAttrListeners;e=d._parentAttrUpdateListeners;var t=!1;if(void 0!==A["*"]||void 0!==z["*"])t=!0;if(!0!==t&&void 0!==k["*"]||void 0!==l["*"]||void 0!==m["*"]||void 0!==e["*"])t=!0;if(!0!==t)for(var q=0;q<h.length;q++)if(void 0!==A[h[q]]||void 0!==z[h[q]]||
void 0!==k[h[q]]||void 0!==l[h[q]]||void 0!==m[h[q]]||void 0!==e[h[q]]){t=!0;break}e=t;h=Object.keys(E);k=Object.keys(B);Object.keys(d._styleListeners);Object.keys(d._styleUpdateListeners);l=Object.keys(d._parentStyleListeners);d=Object.keys(d._parentStyleUpdateListeners);m=[];if(0!==h.length||0!==k.length)m=a(m,h),m=a(m,k);if(0!==m.length&&0!==l.length||0!==d.length)m=a(m,l),m=a(m,d);-1!==m.indexOf("*")&&(m=y);var d=m,h=d.length,w,v,k=[],x,l="outerHTML"===c.attr||"outerText"===c.attr?c.attr:void 0,
...
for(C=0;C<x;C++){if(0!==h)for(v=0;v<h;v++)f.injectStyleProperty(k[C],d[v]);v=k[C].attrListeners();g(e,v._parentAttrListeners);g(t,v._parentAttrUpdateListeners);g(q,v._parentStyleListeners);g(w,v._parentStyleUpdateListeners)}void 0!==l&&(c.attr=l,c.target=m,c.arguments=[])}}function e(a){var c=a.target.attributes[a.arguments[0]],b="setAttribute"===a.attr?a.arguments[1]:"";d(a.target,a.arguments[0],b,void 0!==c?c.value:"",[b])||a.preventDefault()}function k(a){var c=a.target.attributes[a.arguments[0]],
b="setAttribute"===a.attr?a.arguments[1]:"";h(a.target,a.arguments[0],b,void 0!==c?c.value:"",[b])}f.injectPrototypes(Node,"Node");f.injectPrototypes(Element,"Element");f.injectPrototypes(HTMLElement,"HTMLElement");f.injectPrototypes(HTMLInputElement,"HTMLInputElement");f.injectPrototypes(HTMLTextAreaElement,"HTMLTextAreaElement");f.injectPrototypes(Document,"Document");var d=m,h=D;f.addAttrUpdateListener("appendChild",b);f.addAttrUpdateListener("removeChild",b);f.addAttrUpdateListener("innerHTML",
b);f.addAttrUpdateListener("outerHTML",b);f.addAttrUpdateListener("innerText",b);f.addAttrUpdateListener("outerText",b);f.addAttrUpdateListener("textContent",b);f.addAttrListener("setAttribute",e);f.addAttrListener("removeAttribute",e);f.addAttrUpdateListener("setAttribute",k);f.addAttrUpdateListener("removeAttribute",k);return f}var A={},z={},E={},B={},q={},w="textContent innerHTML innerText outerHTML outerText appendChild removeChild replaceChild insertAdjacentHTML insertBefore".split(" "),y=Object.getOwnPropertyNames(document.body.style),
v=Object.keys(HTMLElement.prototype).filter(function(a){return 0===a.indexOf("on")}).concat(["addEventListener","removeEventListener"]),b,m=function(a,b,c,e,f,d){c=new O(a,b,c,e,f,void 0,"set",d);void 0!==a.__kb&&(e=a.__kb._attrListeners,f=a.__kb._styleListeners,d=a.__kb._parentAttrListeners,a=a.__kb._parentStyleListeners,void 0!==e[b]&&t(e[b],c),void 0===c._stopPropogation&&void 0!==f[b]&&t(f[b],c),void 0===c._stopPropogation&&void 0!==e["*"]&&(t(e["*"],c),void 0===c._stopPropogation&&t(f["*"],c)),
void 0===c._stopPropogation&&void 0!==d[b]&&x(d[b],c),void 0===c._stopPropogation&&void 0!==a[b]&&x(a[b],c),void 0===c._stopPropogation&&void 0!==d["*"]&&(x(d["*"],c),void 0===c._stopPropogation&&x(a["*"],c)));void 0===c._stopPropogation&&void 0!==A[b]&&t(A[b],c);void 0===c._stopPropogation&&void 0!==E[b]&&t(E[b],c);void 0===c._stopPropogation&&void 0!==A["*"]&&(t(A["*"],c),void 0===c._stopPropogation&&t(E["*"],c));return void 0!==c._preventDefault?!1:!0},D=function(a,b,c,e,f,d){c=new O(a,b,c,e,f,
