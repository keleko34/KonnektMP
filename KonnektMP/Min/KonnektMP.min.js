...
!0),bindListener:k(e?b.toLowerCase():b),bindProperty:k(e?c.name.toLowerCase():n),bindTarget:k(c,!0),element:k(h,!0),_data:k({},!0),filters:k({},!0),maps:k(a,!0),loop:k(loop)});return f}function I(){return this._value}function N(a){this._value=this.isSynced()?a:this._value;this.refresh()}function O(){return this.element.parentElement?!!this.element.parentElement:this.unsync()}function Q(a,u){function d(a,b){return b.reduce(function(b,c){return b+("string"===typeof c?c:0===c.filterNames.length?c._value:
c.filterNames.reduce(function(b,c){if(void 0!==a.filters){if(void 0!==a.filters[c])return a.filters[c](b);console.warn("there is no filter by the name %o in the data model filters %o",c,Object.keys(a.filters));return b}console.error("Somehow filters object was not added to the mapping via .connect() method, please see dev");return b},c._value))},"")}return 1===u.length?"string"===typeof u[0]._value?d(a,u):u[0]._value:d(a,u)}function H(){"for"!==this.type&&(this.isEvent?this.element[this.bindProperty]=
this.bindText[0]._value:"component"===this.type?(this.element.k_post||(this.element.k_post={}),this.element.k_post["textContent"===this.bindProperty?"innerHTML":this.bindTarget.name]=Q(this,this.bindText)):this.bindTarget[this.bindProperty]=Q(this,this.bindText));return this}function T(a){this._data=a;this.filters=void 0!==a.filters?a.filters:this.filters;a=0;for(var d=this.bindNames.length;a<d;a++)this._data.addDataUpdateListener&&(this._data.exists(this.bindNames[a])||this._data.add(this.bindNames[a],
this._value),this.value=this._data.get(this.bindNames[a]),"component"!==this.type&&(this.isConnected=!0,this._data.addDataUpdateListener(this.bindNames[a],this.updateDom),"for"===this.type&&console.log("run for type event listeners")));1!==this.bindText.length||"text"!==this.type&&"attribute"!==this.type&&!this.isEvent||this.element.addAttrUpdateListener("text"===this.type?"html":this.bindListener,this.updateData);return this}function U(){this.maps[this.key].splice(this.id,1);return this}function G(){for(var a=
0,d=this.bindNames.length;a<d;a++)this._data.removeDataUpdateListener&&this._data.removeDataUpdateListener(this.bindNames[a],this.updateDom);this.element.removeAttrUpdateListener("text"===this.type?"html":this.bindListener,this.updateData);this.maps=this.bindNames=this.filters=this._data=null;this.__proto__._data=null;this.__proto__.element=null;this.__proto__.filters=null;this.__proto__.bindTarget=null;this.__proto__.bindText=null;this.__proto__.bindNames=null;this.__proto__.element=null;this.__proto__.maps=
null;return!1}function F(a){return a.split(new RegExp("("+v.split("").join("\\")+")(.*?)("+r.split("").join("\\")+")","g")).map(function(a,d,l){return l[d-1]===v?v+a+r:a}).filter(function(a,d,l){return 0!==a.length&&a!==v&&a!==r&&0!==a.length})}function P(a){return a.filter(function(a){return-1!==a.indexOf(v)&&-1!==a.indexOf(r)}).map(function(a){return J(a)})}function J(a){return a.replace(new RegExp("["+v+r+"]","g"),"").replace(new RegExp("\\"+x.split("").join("\\")+"(.*)"),"").replace(/\s/g,"")}
function M(a){return-1!==a.indexOf(x)?a.replace(new RegExp("["+r+"]","g"),"").replace(new RegExp("(.*?)(\\"+x.split("").join("\\")+")"),"").replace(/\s/g,"").split(","):[]}function L(a){return-1!==a.indexOf("for")?a.replace(new RegExp("["+v+r+"]","g"),"").replace(/\|(.*)/,"").replace(/\s/g,"").split(/for(.*?)loop/).filter(function(a){return 0!==a.length}):[]}function k(a,d,E){return{value:a,writable:!!d,enumerable:!1,configurable:!!E}}function R(a,d){for(var E=y[a],l=0,b=E.length;l<b&&(E[l](d),d._stopPropogation);l++);
return d._preventDefault}function d(a){var d=a.match(C).map(function(a){return a.replace(/[<\/>]/g,"")});d.filter(function(a,l){return document.createElement(a)instanceof HTMLUnknownElement&&-1===d.indexOf(a,l+1)&&void 0===A[a]});0!==d.length&&R("unknown",new Event("unknown",d));return d}var A={},C=/(<\/.*?>)/g;S().call();var B=Object.keys(HTMLElement.prototype).filter(function(a){return 0===a.indexOf("on")}),v="{{",r="}}",x="|",y={unknown:[]};m.prototype.map=function(a){function d(l){for(var b=0,
n=l.length;b<n;b++)if(void 0===l[b].kb_maps&&8!==l[b].nodeType){l[b].kb_mapper=a;if(3===l[b].nodeType){var c=l[b],h=k,f=c.textContent,e=c.parentElement instanceof HTMLUnknownElement;if(f.match(new RegExp("(\\"+v.split("").join("\\")+")(.*?)(\\"+r.split("").join("\\")+")","g")))for(var g=e?"component":-1!==f.indexOf("for")&&void 0!==f.indexOf("loop")?"for":"text",c=z(h,g,f,F(f),e?"":"textContent","textContent",c,c.parentElement),f=0,e=c.prototype.bindText.length;f<e;f++)0===c.prototype.bindText[f].indexOf(v)&&
(g=new c(c.prototype.bindText[f]),c.prototype.bindText[f]=g,void 0===h[g.key]&&(h[g.key]=[]),g.id=h[g.key].length,h[g.key].push(g))}else for(var h=l[b],c=k,f=h.attributes,e=h instanceof HTMLUnknownElement,g=0,w=f.length;g<w;g++)if(f[g].value.match(new RegExp("(\\"+v.split("").join("\\")+")(.*?)(\\"+r.split("").join("\\")+")","g")))for(var q=z(c,e?"component":"attribute",f[g].value,F(f[g].value),e?"":f[g].name,"value",f[g],h),p=0,t=q.prototype.bindText.length;p<t;p++)if(0===q.prototype.bindText[p].indexOf(v)){var K=
new q(q.prototype.bindText[p]);q.prototype.bindText[p]=K;void 0===c[K.key]&&(c[K.key]=[]);c[K.key].push(K)}l[b].childNodes&&0!==l[b].childNodes.length&&d(l[b].childNodes)}}var k={};d(a.childNodes);return k};m.prototype.addFilter=function(a,d){void 0!==this.maps[a]&&this.maps[a].forEach(function(a){a.filters.push(d);a.refresh()});return this};m.prototype.removeFilter=function(a,d){void 0!==this.maps[a]&&this.maps[a].forEach(function(k){k.filters.splice(this.maps[a].filters.indexOf(d),1);k.refresh()});
return this};m.prototype.swapFilter=function(a,d,k){void 0!==this.maps[a]&&this.maps[a].forEach(function(l){l.filters.splice(this.maps[a].filters.indexOf(d),1,k);l.refresh()});return this};Object.defineProperties(m,{startChars:k(function(a){if(void 0===a)return v;v="string"===typeof a?a:v;return this}),endChars:k(function(a){if(void 0===a)return r;r="string"===typeof a?a:r;return this}),pipeChars:k(function(a){if(void 0===a)return x;x="string"===typeof a?a:x;return this}),getUnknown:k(d),isRegistered:k(function(a){return void 0!==
A[a]}),register:k(function(a,k){void 0===A[a]?(A[a]=k,d(k)):console.error("Class: KonnektMP Method: 'register', A template by the name %o already exists",a);return this}),addEventListener:k(function(a,d){void 0!==y[a]?y[a].push(d):console.error("Class: KonnektMP Method: 'addEventListener', No event exists with the name %o",a);return this}),removeEventListener:k(function(a,d){if(void 0!==y[a])for(var k=0,l=y[a].length;k<l;k++)y[a][k].toString()===d.toString()&&y[a].splice(k,1);else console.error("Class: KonnektMP Method: 'removeEventListener', No event exists with the name %o",
