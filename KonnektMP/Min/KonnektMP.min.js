...
n[0]+");};}())"):void 0,mathFilter:d?eval("(function(){ return function(v){ return (v"+d[0]+");};}())"):void 0}:void 0}}function F(a){if(0!==a.length){for(var e="",b=0,f=a.length;b<f;b++)e="string"===typeof a[b]?e+a[b]:void 0===a[b]._data?e+a[b].text:e+A(a[b]._data.get(a[b].key)||"",a[b].filters.filters,a[b]._data.filters);return e}return A(a[0]._data.get(a[0].key)||"",a[0].filters.filters,a[0]._data.filters)}function A(a,e,b){for(var f=0,n=e.length;f<n;f++)b[e[f]]&&(a=b[e[f]](a));return a}function G(a,
e,b,f){for(var n=0,d=e.length;n<d;n++)if(b[e[n]])b[e[n]](a,f);return a}function H(){function a(a,b){var c=K(b);this.text=a;this.key=b.replace(/(^>|^<*)(.*?)([=*+-\/<>]+)((.*?)+)/g,"$2").replace(/\s/g,"");this.keyLength=this.key.split(".").length;this.localKey=this.key.split(".").pop();var g;g=-1!==a.indexOf(x)?a.replace(new RegExp("["+w+"]","g"),"").replace(new RegExp("(.*?)(\\"+x.split("").join("\\")+")"),"").replace(/\s/g,"").split(","):[];this.filters=I(g);this.component="for"===this.type?E(a)[1]:
...
this.isInput&&-1!==["value","checked"].indexOf(this.attr)?this.node.stopChange()[this.attr]=this._data.get(this.key):"innerHTML"===this.key?(this.node.stopChange().innerHTML="",e(this.node,this._data.innerHTML)):(this.local.stopChange()[this.localAttr]=F(this.bindText),this.isInput&&-1!==["value","checked"].indexOf(this.attr)&&(this.node.stopChange()[this.attr]=this._data.get(this.key)||""));return this}),setLoop:k(function(a,b){switch(b){case "create":this.addPointer(a);break;case "delete":this.removePointer(a);
break;case "set":this.reapplyPointer(a);break;default:if("push"!==b)for(var c=0,e=this._data.getLayer(this.key).length;c<e;c++)this.reapplyPointer(c)}return this}),bindMaps:k([]),unsync:k(function(){this._data=this.__proto__.bindText=null;delete this._data;this.bindMaps=null;delete this.bindMaps;this.binds=null;delete this.binds;return this})});return a}var m="{{",w="}}",x="|",v={},L=/(<\/.*?>)/g;z().call();var M=Object.keys(HTMLElement.prototype).filter(function(a){return 0===a.indexOf("on")}),r=
{loopitem:[]};d.start=function(a){if(void 0===a)return m;m="string"===typeof a?a:m;return d};d.end=function(a){if(void 0===a)return w;w="string"===typeof a?a:w;return d};d.pipe=function(a){if(void 0===a)return x;x="string"===typeof a?a:x;return d};d.getUnknown=function(a){var e=a.match(L).map(function(a){return a.replace(/[<\/>]/g,"")});e.filter(function(a,f){return document.createElement(a)instanceof HTMLUnknownElement&&-1===e.indexOf(a,f+1)&&void 0===v[a]});return e};d.isRegistered=function(a){return void 0!==
v[a]};d.register=function(a,e){void 0===v[a]?(v[a]=e,d.getUnknown(e)):console.error("Class: KonnektMP Method: 'register', A template by the name %o already exists",a);return this};d.addEventListener=function(a,e){void 0!==r[a]?r[a].push(e):console.error("Class: KonnektMP Method: 'addEventListener', No event exists with the name %o",a);return d};d.removeEventListener=function(a,e){if(void 0!==r[a])for(var b=0,f=r[a].length;b<f;b++)r[a][b].toString()===e.toString()&&r[a].splice(b,1);else console.error("Class: KonnektMP Method: 'removeEventListener', No event exists with the name %o",
a);return d};Object.defineProperties(d.prototype,{register:k(d.register),isRegistered:k(d.isRegistered),getUnknown:k(d.getUnknown),map:k(function(a){function e(b,f){for(var d=0,k=b.length;d<k;d++)if(void 0===b[d].kb_maps&&8!==b[d].nodeType){b[d].kb_mapper=a;b[d].kb_maps=f;if(3===b[d].nodeType){var p=b[d],q=f,l=p.textContent;if(l.match(B())){var t=C(l),c=H();c.prototype.type=l.match(new RegExp("(\\"+m.split("").join("\\")+")(.*?)(for)(.*?)(loop)(.*?)(\\"+w.split("").join("\\")+")","g"))?"for":"text";
c.prototype.text=l;c.prototype.bindText=t;c.prototype.listener="textContent";c.prototype.attr="textContent";c.prototype.localAttr="textContent";c.prototype.local=p;c.prototype.node=p.parentElement;c.prototype.binds=q;p=0;for(l=t.length;p<l;p++)if(0===t[p].indexOf(m)){var g="for"===c.prototype.type?E(t[p])[0]:D(t[p]),u=new c(t[p],g);void 0===q[g]&&(q[g]=[]);u.bindText[p]=u;u.bindMaps.push(u);u.id=q[g].length;q[g].push(u)}}}else for(q=b[d],t=f,c=Array.prototype.slice.call(q.attributes),p=q instanceof
HTMLUnknownElement,l=0,g=c.length;l<g;l++)if(c[l].value.match(B())){var u=C(c[l].value),h=H();h.prototype.type=p?"component":"attribute";h.prototype.text=c[l].value;h.prototype.bindText=u;h.prototype.isEvent=-1!==M.indexOf(c[l].name);h.prototype.isInput="input"===q.tagName.toLowerCase();h.prototype.isRadio=h.prototype.isInput?-1!==["radio","checkbox"].indexOf(q.type):!1;h.prototype.listener=c[l].name;h.prototype.attr=c[l].name;h.prototype.localAttr="value";h.prototype.local=c[l];h.prototype.node=
q;h.prototype.binds=t;h.prototype.isEvent&&q.removeAttribute(c[l].name);for(var r=0,x=u.length;r<x;r++)if(0===u[r].indexOf(m)){var v=D(u[r]),y=new h(u[r],v);void 0===t[v]&&(t[v]=[]);y.bindText[r]=y;y.bindMaps.push(y);y.id=t[v].length;t[v].push(y)}}b[d].childNodes&&0!==b[d].childNodes.length&&(f=e(b[d].childNodes,f))}return f}return e(a.childNodes,{})}),insert:k(d.insert)});return d}}(Createkb);"undefined"!==typeof window&&"undefined"!==typeof window.define&&"undefined"!==typeof window.require?define([],
function(){return z}):"undefined"!==typeof module&&(module.exports=z);return z}();
