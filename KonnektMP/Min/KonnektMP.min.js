...
function w(a,n,f,b,g,c,d,k){function e(b){var g="for"===n?J(b):[],c=this;this.key="for"!==n?K(b):g[0];this.filterNames=M(b);this.component="for"===n?g[1]:void 0;this.id=0;this.isEvent=h;this.__proto__.bindText=this.__proto__.bindText.map(function(g){return g===b?this:g});Object.defineProperties(this,{value:{get:this.valget,set:this.valset,enumerable:!0,configurable:!1},_value:l("",!0)});this.__proto__.updateData=function(b){if(c.isConnected&&c._data){if("object"!==typeof b||void 0===b.value)b={value:b};
"function"===typeof c._data.stopChange&&c._data.stopChange().set(c.key,b.value)}};this.__proto__.updateDom=function(b){if(c.isSynced()){c.element.stopChange();if("object"!==typeof b||void 0===b.value)b={value:b};c.value=b.value}};this.__proto__.updateLoop=function(){c.kb_loop&&c.loop(c.kb_loop)}}var h="attribute"===n&&-1!==B.indexOf(d.name)||"component"===n&&d.name&&-1!==B.indexOf(d.name);h&&k.stopChange().removeAttribute(d.name);Object.defineProperties(e.prototype,{valget:l(I),valset:l(N),refresh:l(H),
connect:l(T),deleteMap:l(E),loop:l(O),unsync:l(F),isSynced:l(P),type:l(n),text:l(f,!0),bindText:l(b,!0),bindNames:l("for"===n?[J(b[0])[0]]:Q(b),!0),bindListener:l(h?g.toLowerCase():g),bindProperty:l(h?d.name.toLowerCase():c),bindTarget:l(d,!0),element:l(k,!0),_data:l({},!0),filters:l({},!0),maps:l(a,!0),loop:l(O)});return e}function I(){return this._value}function N(a){this._value=this.isSynced()?a:this._value;this.refresh()}function P(){return this.element.parentElement?!!this.element.parentElement:
this.unsync()}function R(a,n){function f(b,g){return g.reduce(function(g,d){return g+("string"===typeof d?d:0===d.filterNames.length?d._value:d.filterNames.reduce(function(g,c){if(void 0!==b.filters){if(void 0!==b.filters[c])return b.filters[c](g);console.warn("there is no filter by the name %o in the data model filters %o",c,Object.keys(b.filters));return g}console.error("Somehow filters object was not added to the mapping via .connect() method, please see dev");return g},d._value))},"")}return 1===
n.length?"string"===typeof n[0]._value?f(a,n):n[0]._value:f(a,n)}function H(){"for"!==this.type&&(this.isEvent?this.element[this.bindProperty]=this.bindText[0]._value:"component"===this.type?(this.element.k_post||(this.element.k_post={}),this.element.k_post["textContent"===this.bindProperty?"innerHTML":this.bindTarget.name]=R(this,this.bindText)):this.bindTarget[this.bindProperty]=R(this,this.bindText));return this}function T(a){this._data=a;this.filters=void 0!==a.filters?a.filters:this.filters;
a=0;for(var n=this.bindNames.length;a<n;a++){var f=this.bindNames[a];this._data.addDataUpdateListener&&(this._data.exists(f)||(console.warn("No property by the name %o exists on this data set %o",f,this._data),this._data.add(f,this._value)),this.value=this._data.get(f),"component"!==this.type&&"for"!==this.type?(this.isConnected=!0,this._data.addDataUpdateListener(f,this.updateDom)):"for"===this.type&&this._value.addDataUpdateListener&&this._value.addDataUpdateListener("*",this.updateLoop).addDataCreateListener(this.updateLoop).addDataDeleteListener(this.updateLoop))}1!==
